...
function getWeather() {
    ...
    /*https://api.openweathermap.org/data/2.5/weather?q=miami}&appid=786fa656f894f94166c199b7391b92fc*/
    ...
    .then(data => {
        ...
        document.querySelector(".cityDisplay").innerHTML = `${city.charAt(0).toUpperCase()}${city.slice(1)}`;
...
function changeui() {
 ...
 const currentTheme = document.body.getAttribute("dataTheme");
